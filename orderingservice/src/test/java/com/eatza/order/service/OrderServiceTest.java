...
import com.eatza.order.service.orderservice.CustomerService;
...
public class OrderServiceTest {
	...
	CustomerDTO customer = new CustomerDTO(1L, "mourya", 90909L, (byte) 22, "isActive","InOrdered");
	ResponseEntity<CustomerDTO> customerResponse = new ResponseEntity<CustomerDTO>(customer, HttpStatus.OK);
	
	
	@Test
	public void placeOrder_basic() throws OrderException, CustomerException {
		...
		when(customerService.getCustomerById(orderRequest.getCustomerId())).thenReturn(customerResponse);
	...
	public void placeOrder_different_restaurant() throws OrderException, CustomerException {
	...
	@Test(expected = OrderException.class)
	public void placeOrder_no_item() throws OrderException, CustomerException {
		OrderedItemsDto orderedItemsDto = new OrderedItemsDto(1L, 0);
		orderedItemsDto.setItemId(1L);
		orderedItemsDto.setQuantity(1);
	...
	@Test(expected = OrderException.class)
	public void placeOrder_quantity_zero() throws OrderException, CustomerException {
		OrderedItemsDto orderedItemsDto = new OrderedItemsDto(1L, 0);
		orderedItemsDto.setItemId(1L);
