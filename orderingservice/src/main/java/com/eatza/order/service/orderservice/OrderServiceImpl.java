...
import com.eatza.order.feignclient.RestuaranteignClient;
...
//	@Value("${kafka.topic.name}")
	...
	@Autowired
	RestuaranteignClient restuarantClient;
	...
	public Order placeOrder(OrderRequestDto orderRequest) throws OrderException {
		...
		for (OrderedItemsDto itemDto : itemsDtoList) {
			...
			try {
				...
				ItemFetchDto item = restuarantClient.getItemById(itemDto.getItemId());
